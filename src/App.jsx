...
function App() {
  ...
  return (
    <>
        ...
        <h2 className='subtituloPrincipal'>{modoEdicion ? "Editar película o serie" : "Agregar nueva película o serie"}</h2>
        <FormularioItem
          item={itemActual}
        ...
        <div className='mostradorPeliculas'>
          <div className='vistas'>
            ...
            />
            <p className='contador'><strong>Cantidad de películas y series vistas: </strong>{totalVistas}</p>
          </div>
          <div className='noVistas'>
            ...
            />
            <p className='contador'><strong>Cantidad de películas y series por ver: </strong>{totalNoVistas}</p>
          </div>
        </div>
